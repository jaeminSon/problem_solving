import sys
sys.path.append("..")
from custom_type import GRAPH, GRAPH_NONNEGEDGE, NODE

import heapq
from collections import deque


def dijkstra(adjacency_list: GRAPH_NONNEGEDGE, s: NODE, t: NODE) -> int:
...
def bellman_ford(adjacency_list: GRAPH, s: NODE):
...
def bellman_ford_fast(adjacency_list: GRAPH, s: NODE):
...
def floyd_warshall(adjacency_list: GRAPH):
...
if __name__ == "__main__":
    ans = [
        ...
        ([0, 1, 2, 8], 14)]
    for t in range(9):
        assert dijkstra([[(1, 4), (7, 8)], [(0, 4), (2, 8), (7, 11)], [(1, 8), (3, 7), (5, 4), (8, 2)], [(2, 7), (4, 9), (5, 14)], [(3, 9), (5, 10)], [
              (2, 4), (3, 14), (4, 10), (6, 2)], [(5, 2), (7, 1), (8, 6)], [(0, 8), (1, 11), (6, 1), (8, 7)], [(2, 2), (6, 6), (7, 7)]], 0, t) == ans[t]
    
    assert bellman_ford([[(1, -1), (2, 4)], [(2, 3), (3, 2), (4, 2)], [], [(2, 5), (1, 1)], [(3, -3)]], 0) == [0, -1, 2, -2, 1]
    assert bellman_ford_fast([[(1, -1), (2, 4)], [(2, 3), (3, 2), (4, 2)], [], [(2, 5), (1, 1)], [(3, -3)]], 0) == [0, -1, 2, -2, 1]
    assert bellman_ford_fast([[(1, -1)], [(0, -1)]], 0) == None
    assert floyd_warshall([[(1, 5), (3, 10)], [(2, 3)], [(3, 1)], []]) == [[0, 5, 8, 9], [float("Inf"), 0, 3, 4],

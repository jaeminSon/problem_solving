...
if __name__ == "__main__":
    ...
    print(tarjan_scc(edge2adjacencylist([[0, 1], [1, 2], [2, 0], [1, 3], [1, 4], [1, 6], [3, 5], [4, 5]])))  # [[5], [3], [4], [6], [2, 1, 0]]
    print(tarjan_scc(edge2adjacencylist([[1, 0], [0, 2], [2, 1], [0, 3], [3, 4]])))  # [[4], [3], [1, 2, 0]]
    print(tarjan_scc(edge2adjacencylist([[0, 1], [1, 2], [2, 3]])))  # [[3],[2],[1],[0]]
    print(tarjan_scc(edge2adjacencylist([[0, 1], [1, 2], [2, 0], [1, 3], [1, 4], [1, 6], [3, 5], [4, 5]])))  # [[5],[3],[4],[6],[2,1,0]]
    print(tarjan_scc(edge2adjacencylist([[0, 1], [0, 3], [1, 2], [1, 4], [2, 0], [2, 6], [3, 2], [4, 5], [4, 6],
          [5, 6], [5, 7], [5, 8], [5, 9], [6, 4], [7, 9], [8, 9], [9, 8]])))  # [[8,9],[7],[5,4,6],[3,2,1,0]]
    print(tarjan_scc(edge2adjacencylist([[0, 1], [1, 2], [2, 3], [2, 4], [3, 0], [4, 2]])))  # [[4,3,2,1,0]]

    print(kosaraju_scc(edge2adjacencylist([[0, 1], [0, 3], [1, 2], [1, 4], [2, 0], [2, 6], [3, 2], [4, 5], [4, 6],
          [5, 6], [5, 7], [5, 8], [5, 9], [6, 4], [7, 9], [8, 9], [9, 8]])))  # [[8,9],[7],[5,4,6],[3,2,1,0]]

...
if __name__ == "__main__":
    print(kruskal_mst([[(1,10),(2,6),(3,5)],[(0,10),(3,15)],[(0,6),(3,4)],[(0,5),(2,4)]])) # [(2, 3, 4), (0, 3, 5), (0, 1, 10)]
    print(prim_mst([[(1,10),(2,6),(3,5)],[(0,10),(3,15)],[(0,6),(3,4)],[(0,5),(2,4)]])) #[(2, 3, 4), (3, 0, 5), (0, 1, 10)]
    print(kruskal_mst([[(1,2),(3,6)],[(0,2),(2,3),(3,8),(4,5)],[(1,3),(3,7)],[(0,6),(1,8),(4,9)],[(1,5),(2,7),(3,9)]])) # [(0, 1, 2), (1, 2, 3), (1, 4, 5), (0, 3, 6)]
    print(prim_mst([[(1,2),(3,6)],[(0,2),(2,3),(3,8),(4,5)],[(1,3),(3,7)],[(0,6),(1,8),(4,9)],[(1,5),(2,7),(3,9)]])) # [(0, 1, 2), (1, 2, 3), (1, 4, 5), (0, 3, 6)]
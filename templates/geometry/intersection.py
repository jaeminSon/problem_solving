import sys
sys.path.append("..")
from custom_type import POINT2D, POLYGON2D, REAL


def intersection_two_lines(a1: REAL, b1: REAL, c1: REAL, a2: REAL, b2: REAL, c2: REAL) -> POINT2D:
    # a1x+b1y+c1=0
    # a2x+b2y+c2=0
    d = a1*b2-a2*b1
...
def intersection_two_segments(x1: REAL, y1: REAL, x2: REAL, y2: REAL, x3: REAL, y3: REAL, x4: REAL, y4: REAL) -> POINT2D:
...
def circle_line(cx: REAL, cy: REAL, r_square: REAL, a: REAL, b: REAL, c: REAL) -> POINT2D:
...
def two_circles(cx1: REAL, cy1: REAL, r1_square: REAL, cx2: REAL, cy2: REAL, r2_square: REAL) -> POLYGON2D:

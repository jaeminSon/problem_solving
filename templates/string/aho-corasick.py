...
class AhoCorasick:
    def __init__(self, words: STRING):
        """
        the Aho–Corasick algorithm is a string-searching algorithm,
        which constructs a finite-state machine that resembles a trie, 
    ...
    def search_words(self, text: STRING) -> LIST1D:
